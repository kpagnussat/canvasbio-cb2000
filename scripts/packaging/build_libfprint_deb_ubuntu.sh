...
install -m 0644 "${PROJECT_ROOT}/COPYRIGHT" "${DOC_DIR}/COPYRIGHT"
install -m 0644 "${PROJECT_ROOT}/THIRD_PARTY_NOTICES.md" "${DOC_DIR}/THIRD_PARTY_NOTICES.md"
install -m 0644 "${PROJECT_ROOT}/third_party_licenses/SIGFM-MIT.txt" "${DOC_DIR}/SIGFM-MIT.txt"

# Keep the release package runtime-only. Development headers, pkg-config files,
# GIR sources and installed-tests belong in developer builds, not public assets.
rm -rf \
