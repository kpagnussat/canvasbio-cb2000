...
install -m 0644 "${PROJECT_ROOT}/README.md" "${RPMBUILD_DIR}/SOURCES/README.canvasbio.md"
install -m 0644 "${PROJECT_ROOT}/LICENSE" "${RPMBUILD_DIR}/SOURCES/LICENSE.canvasbio"
install -m 0644 "${PROJECT_ROOT}/COPYRIGHT" "${RPMBUILD_DIR}/SOURCES/COPYRIGHT.canvasbio"
install -m 0644 "${PROJECT_ROOT}/THIRD_PARTY_NOTICES.md" "${RPMBUILD_DIR}/SOURCES/THIRD_PARTY_NOTICES.canvasbio.md"
install -m 0644 "${PROJECT_ROOT}/third_party_licenses/SIGFM-MIT.txt" "${RPMBUILD_DIR}/SOURCES/SIGFM-MIT.txt"
