#!/usr/bin/env bash
# gate_summary.sh — Enrollment gate summary for a session.
# Usage: ./gate_summary.sh --run RUN_DIR [options]
...
exec python3 "${PROJECT_ROOT}/scripts/cb2000_verify_gate_summary.py" "$@"
